...
ollama = OpenAI(base_url="http://127.0.0.1:11434",api_key="none")
...
With this context, please answer the user's question. Be accurate, relevant and complete. If you dont know the answer please say so. Do not make 
fake answers.
"""
...
'''def fetch_context_unranked(question):
    ...
    return chunks'''
def fetch_context_unranked(question):
    # create embedding using HF model
